...
CUDA_VISIBLE_DEVICES=0 python3 main.py \
  ...
  --sub_dir aeroplane2wider-only-detector-image \
  --batch_size 1 \
  --epoch 300 \
  --lr_decay_epoch 150
...
#  --phase train \
#  --class_name ball \
#  --train_A_path ./datasets/ball-with-annotation/train \
#  --test_A_path ./datasets/ball-with-annotation/test \
#  --train_B_path ./datasets/wider-face-with-annotation \
#  --test_B_path ./datasets/FDDB-with-annotation \
#  --sub_dir ball2wider-only-detector-image \
#  --batch_size 1 \
#  --epoch 300 \
#  --lr_decay_epoch 150
